  ...
  return (
    <section className="py-20 px-4 bg-white" id="details">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-stone-50 border border-amber-200 p-12 md:p-16 shadow-sm">
          <div className="text-center mb-12">
            <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <Church className="w-8 h-8 text-amber-600" />
            </div>
            <h3 className="text-2xl font-light text-stone-800 mb-4 tracking-widest">
              WEDDING CEREMONY
            </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 text-center md:text-left">
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row items-center md:items-start text-stone-700">
                ...
                <div>
                  ...
                  <p className="text-stone-500 font-light tracking-widest text-sm">
                    2025
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row items-center md:items-start text-stone-700">
                ...
                <div>
                  <p className="font-light text-lg tracking-wide mb-2">
                    LOURDES METROPOLITAN CATHEDRAL
                  </p>
                  <p className="text-stone-500 text-sm font-light tracking-wide leading-relaxed">
                    A sacred place where we will begin our journey as husband
                    and wife
                  </p>
                </div>
              </div>
